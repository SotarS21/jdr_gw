...
GW.competences = {
  ...
  persuasionDeForce: { label: "GALACTICWARS.Competence.PersuasionDeForce", metier: true, force: true, caracteristique: "mental", reservee: true },
  ...
  sabreLaser: { label: "GALACTICWARS.Competence.SabreLaser", metier: true, force: true, caracteristique: "dexterite", reservee: true },
  ...
  pousseeDeForce: { label: "GALACTICWARS.Competence.PousseeDeForce", metier: true, force: true, caracteristique: "corps", reservee: true },
