...
- **v0.16.1** : 4 nouveaux vaisseaux au compendium (Pourparler, Lance d'argent, La Brique, Lumière de l'aube), images de l'auteur réduites dans `asset_visuel/objets/vaisseaux-*` (acteur, portrait, token) ; caractéristiques **estimées** (choix de l'auteur), calibrées sur les vaisseaux existants et signalées dans la description.
